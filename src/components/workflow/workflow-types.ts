...
export const workflowTemplates: Record<string, WorkflowConfig> = {
  "Vente immobilière": {
    ...
    steps: [
      { key: "collecte_documents",       label: "COLLECTE DOCUMENTS",      description: "Collecte des documents nécessaires à la vente",         icon: "FolderOpen",    time: "7 j",  status: "pending", button: { actionId: "collecte_documents" } },
      { key: "verification_juridique",   label: "VÉRIFICATION JURIDIQUE",  description: "Vérification juridique des titres et situation",        icon: "Scale",         time: "10 j", status: "pending", button: { actionId: "verification_juridique" } },
      { key: "redaction_compromis",      label: "RÉDACTION COMPROMIS",     description: "Rédaction du compromis de vente",                       icon: "PenLine",       time: "5 j",  status: "pending", button: { actionId: "redaction_compromis" } },
      { key: "signature_compromis",      label: "SIGNATURE COMPROMIS",     description: "Signature du compromis par les parties",                icon: "FileSignature", time: "3 j",  status: "pending", button: { actionId: "signature_compromis" } },
      { key: "purge_preemption",         label: "PURGE PRÉEMPTION",        description: "Purge des droits de préemption (DPU)",                  icon: "Clock",         time: "30 j", status: "pending", button: { actionId: "purge_preemption" } },
      { key: "redaction_acte",           label: "RÉDACTION ACTE",          description: "Rédaction de l'acte authentique de vente",              icon: "FileText",      time: "7 j",  status: "pending", button: { actionId: "redaction_acte" } },
      { key: "signature_acte",           label: "SIGNATURE ACTE",          description: "Signature de l'acte authentique par les parties",       icon: "CheckCircle2",  time: "1 j",  status: "pending", button: { actionId: "signature_acte" } },
      { key: "enregistrement_publicite", label: "ENREGISTREMENT",          description: "Enregistrement et publicité foncière",                  icon: "Stamp",         time: "15 j", status: "pending", button: { actionId: "enregistrement_publicite" } },
    ],
  },
  "Vente de terrain": {
    layout: "horizontal",
  ...
  "Succession": {
    ...
    palette: WORKFLOW_PALETTE,
    steps: [
      { key: "ouverture_succession",    label: "OUVERTURE",           description: "Ouverture de la succession et désignation des héritiers", icon: "BookOpen",      time: "7 j",  status: "pending", button: { actionId: "ouverture_succession" } },
      { key: "inventaire_patrimoine",   label: "INVENTAIRE",          description: "Inventaire complet du patrimoine du défunt",              icon: "ClipboardList", time: "30 j", status: "pending", button: { actionId: "inventaire_patrimoine" } },
      { key: "declaration_succession",  label: "DÉCLARATION",         description: "Déclaration de succession auprès des impôts",            icon: "FileText",      time: "15 j", status: "pending", button: { actionId: "declaration_succession" } },
      { key: "calcul_droits",           label: "CALCUL DROITS",       description: "Calcul des droits de succession applicables",            icon: "Calculator",    time: "7 j",  status: "pending", button: { actionId: "calcul_droits" } },
      { key: "paiement_droits",         label: "PAIEMENT DROITS",     description: "Paiement des droits de succession",                     icon: "CreditCard",    time: "10 j", status: "pending", button: { actionId: "paiement_droits" } },
      { key: "partage_transfert",       label: "PARTAGE & TRANSFERT", description: "Partage des biens et transfert aux héritiers",           icon: "Users",         time: "15 j", status: "pending", button: { actionId: "partage_transfert" } },
    ],
  },
  "Donation": {
    layout: "horizontal",
    palette: WORKFLOW_PALETTE,
    steps: [
      { key: "collecte_documents",   label: "COLLECTE DOCUMENTS",  description: "Collecte des documents relatifs aux biens et parties",  icon: "FolderOpen",    time: "5 j",  status: "pending", button: { actionId: "collecte_documents" } },
      { key: "evaluation_biens",     label: "ÉVALUATION BIENS",    description: "Évaluation de la valeur des biens donnés",              icon: "BarChart2",     time: "7 j",  status: "pending", button: { actionId: "evaluation_biens" } },
      { key: "calcul_droits",        label: "CALCUL DROITS",       description: "Calcul des droits de donation applicables",             icon: "Calculator",    time: "3 j",  status: "pending", button: { actionId: "calcul_droits" } },
      { key: "redaction_acte",       label: "RÉDACTION ACTE",      description: "Rédaction de l'acte de donation",                      icon: "PenLine",       time: "5 j",  status: "pending", button: { actionId: "redaction_acte" } },
      { key: "signature_acte",       label: "SIGNATURE ACTE",      description: "Signature de l'acte par le donateur et le donataire",  icon: "FileSignature", time: "1 j",  status: "pending", button: { actionId: "signature_acte" } },
      { key: "enregistrement_fiscal", label: "ENREGISTREMENT",     description: "Enregistrement fiscal de la donation",                 icon: "Stamp",         time: "10 j", status: "pending", button: { actionId: "enregistrement_fiscal" } },
    ],
  },
  "Bail commercial": {
    layout: "horizontal",
  ...
  "Procuration": {
    ...
    palette: WORKFLOW_PALETTE,
    steps: [
      { key: "verification_identite", label: "VÉRIFICATION IDENTITÉ", description: "Vérification de l'identité du mandant",       icon: "Search",        time: "2 j", status: "pending", button: { actionId: "verification_identite" } },
      { key: "redaction_procuration", label: "RÉDACTION",             description: "Rédaction de la procuration notariée",        icon: "PenLine",       time: "2 j", status: "pending", button: { actionId: "redaction_procuration" } },
      { key: "signature",             label: "SIGNATURE",             description: "Signature de la procuration par le mandant",  icon: "FileSignature", time: "1 j", status: "pending", button: { actionId: "signature" } },
      { key: "legalisation",          label: "LÉGALISATION",          description: "Légalisation et délivrance de la procuration", icon: "Stamp",         time: "1 j", status: "pending", button: { actionId: "legalisation" } },
    ],
  },
