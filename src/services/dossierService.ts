// ─────────────────────────────────────────────────────────────────────────────
// Service Dossiers — consomme les endpoints /api/dossiers
// ─────────────────────────────────────────────────────────────────────────────
...
/** Convertit le libellé français d'un acte en valeur enum backend */
export function typeActeValue(label: string): string {
  const map: Record<string, string> = {
    "Vente immobilière": "VENTE_IMMOBILIERE",
    "Promesse de vente (compromis)": "VENTE_IMMOBILIERE",
    "Échange de biens immobiliers": "VENTE_IMMOBILIERE",
    "Donation immobilière": "DONATION_IMMOBILIERE",
    "Donation entre époux": "DONATION_IMMOBILIERE",
    "Donation-partage": "DONATION_PARTAGE",
    "Partage successoral": "DONATION_PARTAGE",
    ...
    "Changement de régime matrimonial": "CONTRAT_MARIAGE",
    ...
    "Procès-verbal d'assemblée": "CREATION_SOCIETE",
    "Nomination de dirigeants": "CREATION_SOCIETE",
    "Augmentation de capital": "AUGMENTATION_CAPITAL",
    ...
    "Liquidation du régime matrimonial": "LIQUIDATION_REGIME",
  ...
  return map[label] ?? "CONTRAT_DIVERS";
}
